...
import { TableOrders, useOrders } from "@/features/orders";
...

      {
        orders.length === 0 ? (
          <>
            ...
            <Link to='/smartphones' className="bg-indigo-600 text-white uppercase font-semibold tracking-widest text-xs py-4 rounded-full px-8">Empezar a Comprar</Link>
          </>
        ) : (
